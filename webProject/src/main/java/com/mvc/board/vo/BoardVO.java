...
public class BoardVO {
	...
	private int repRoot;		// 답변글 작성 시 사용 (원래 글의 번호 참조)
	private int repStep;		// 답변글 작성 시 사용 (답변 글의 들여쓰기 지정)
	private int repIndent;		// 답변글 작성 시 사용 (답변 글의 순서 지정)
	private String passwd;		// 비밀번호
	private int rCount;			// 답변글 개수
